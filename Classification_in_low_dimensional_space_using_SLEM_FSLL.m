...
% % The loaded matrixes consist random selection of the Persian handwritten character images from HODA
...
% Therfore, we have a train data matrix as 401x16000 and a test data matrix as 401x9600 ((D+1)xN).

% load('Hoda_labeled_HODA_Train_Test.mat', 'labled_Trian_chr_HODA_500')
% load('Hoda_labeled_HODA_Train_Test.mat', 'labled_Test_chr_HODA_300')
...
% % The loaded matrixes consist random selection of the Persian handwritten digit images from FHT
